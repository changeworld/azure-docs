...
ms.custom:
  - build-2025
# customer intent: As a GeoCatalog User I want to understand how Data Cubes are supported in Microsoft Planetary Computer Pro so that I can ingest, manage, and visualize data cube data formats.
---
